...
## FOR FALCON ASMS 
## ONLY need to fill out FALCONDIR and ASMOUTPREFIX
## FALCONDIR contains p_ctg.fa and a_ctg.fa -- usually named 2-asm-falcon (best to give abs path to it)
...
REF=${FALCONDIR}/p_ctg.fa            ## path to pre-quiver asm to polish
BUBBLES_ETC=${FALCONDIR}/a_ctg.fa    ##e.g. canu.bubbles.fasta or falcon.a_ctg.fasta; Only add canu.unasm.fa file if it has been pre-filtered or you want to use all contents - else put it in CANU_UNASM variable below
