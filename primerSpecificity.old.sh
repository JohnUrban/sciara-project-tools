...
A=`bowtie2 -x $BT2 -U $P1 -f -a --maxins 10000 | samtools view -S -F 4 - | grep -v ^@ | cut -f 1,2,3,4,5,6,7,9,12,13,14,15,16,17,18,19,20 | tee /dev/tty | wc -l`
echo
echo "Primer 1 maps to" $A "site(s) independently."
echo

echo "MAPPING PRIMER 2 INDEPENDENTLY"
B=`bowtie2 -x $BT2 -U $P2 -f -a --maxins 10000 | samtools view -S -F 4 - | grep -v ^@ | cut -f 1,2,3,4,5,6,7,9,12,13,14,15,16,17,18,19,20 | tee /dev/tty | wc -l`
echo
echo "Primer 2 maps to" $B "site(s) independently."
echo

echo "MAPPING PRIMER 1 INDEPENDENTLY - LESS STRINGENT"
AL=`bowtie2 --rdg 2,2 --rfg 2,2 --mp 2 --very-sensitive -N 1 -x $BT2 -U $P1 -f -a --maxins 10000 | samtools view -S -F 4 - | grep -v ^@ | cut -f 1,2,3,4,5,6,7,9,12,13,14,15,16,17,18,19,20 | tee /dev/tty | wc -l`
echo
echo "Primer 1 maps to" $AL "site(s) independently - less stringently."
echo

echo "MAPPING PRIMER 2 INDEPENDENTLY - LESS STRINGENT"
BL=`bowtie2 --rdg 2,2 --rfg 2,2 --mp 2 --very-sensitive -N 1 -x $BT2 -U $P2 -f -a --maxins 10000 | samtools view -S -F 4 - | grep -v ^@ | cut -f 1,2,3,4,5,6,7,9,12,13,14,15,16,17,18,19,20 | tee /dev/tty | wc -l`
echo
...
AA=`bowtie2 --no-discordant --no-mixed -x $BT2 -1 $P1 -2 $P2 -f -a --maxins 10000 | samtools view -S -F 4 - | grep -v ^@ | cut -f 1,2,3,4,5,6,7,9,12,13,14,15,16,17,18,19,20 | tee /dev/tty | wc -l`
AA=`echo $AA/2 | bc`
echo
...
BB=`bowtie2 --no-discordant --no-mixed --rdg 2,2 --rfg 2,2 --mp 2 --very-sensitive -N 1 -x $BT2 -1 $P1 -2 $P2 -f -a --maxins 10000 | samtools view -S -F 4 - | grep -v ^@ | cut -f 1,2,3,4,5,6,7,9,12,13,14,15,16,17,18,19,20 | tee /dev/tty | wc -l`
BB=`echo $BB/2 | bc`
echo
...
CC=`bowtie2 --no-discordant --no-mixed -x $BT2 -1 $P1 -2 $P1 -f -a --maxins 10000 | samtools view -S -F 4 - | grep -v ^@ | cut -f 1,2,3,4,5,6,7,9,12,13,14,15,16,17,18,19,20 | tee /dev/tty | wc -l`
CC=`echo $CC/2 | bc`
echo
...
DD=`bowtie2 --no-discordant --no-mixed -x $BT2 -1 $P2 -2 $P2 -f -a --maxins 10000 | samtools view -S -F 4 - | grep -v ^@ | cut -f 1,2,3,4,5,6,7,9,12,13,14,15,16,17,18,19,20 | tee /dev/tty | wc -l`
DD=`echo $DD/2 | bc`
echo
...
CCL=`bowtie2 --no-discordant --no-mixed --rdg 2,2 --rfg 2,2 --mp 2 --very-sensitive -N 1 -x $BT2 -1 $P1 -2 $P1 -f -a --maxins 10000 | samtools view -S -F 4 - | grep -v ^@ | cut -f 1,2,3,4,5,6,7,9,12,13,14,15,16,17,18,19,20 | tee /dev/tty | wc -l`
CCL=`echo $CCL/2 | bc`
echo
...
DDL=`bowtie2 --no-discordant --no-mixed --rdg 2,2 --rfg 2,2 --mp 2 --very-sensitive -N 1 -x $BT2 -1 $P2 -2 $P2 -f -a --maxins 10000 | samtools view -S -F 4 - | grep -v ^@ | cut -f 1,2,3,4,5,6,7,9,12,13,14,15,16,17,18,19,20 | tee /dev/tty | wc -l`
DDL=`echo $DDL/2 | bc`
echo
...
if [ $# -eq 5 ]; then
 ...
 bowtie2 --no-discordant --no-mixed -x $1 -1 $2 -2 $3 -f -a --maxins 10000 | samtools view -S -F 4 - | grep -v ^@ | grep ^p1 | awk 'OFS="\t" {print $3,$4,$4+$9+1}' | fastaFromBed -fi $5 -bed - -fo $TARGET
 echo
 BLAST=`blastn -db $4 -query $TARGET -outfmt 6 -culling_limit 1 | tee /dev/tty | wc -l`
 echo
fi
